...
namespace RaptoreumWallet.Api.Extensions
{
    public static class StringExtensions
    {
        ...
        public static TimeSpan ToTimeSpan(this string time, string pattern = null)
        {
            if (string.IsNullOrEmpty(time))
            {
            ...
            try
            {
                return TimeSpan.ParseExact(time, pattern ?? "hh:mm", System.Globalization.CultureInfo.InvariantCulture);
            }
            catch
            {
                return TimeSpan.Zero;
